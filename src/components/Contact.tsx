...
const socialLinks = [
  {
    name: "GitHub",
    icon: FiGithub,
    url: "https://github.com/Bhuvansai-16",
    color: "hover:text-gray-300",
  },
  {
    name: "LinkedIn",
    icon: FiLinkedin,
    url: "https://www.linkedin.com/in/bhuvansaich/",
    ...
    <section id="contact" className="py-16 sm:py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          >
            <motion.a
              href="mailto:chbhuvansai522@gmail.com"
            ...
            >
              ...
              <span className="hidden sm:inline">chbhuvansai522@gmail.com</span>
          ...
          >
            <p className={`text-xs sm:text-sm ${isDark ? "text-white/60" : "text-white/60"}`}>
              © {new Date().getFullYear()} Chilamkurthi Bhuvansai
            </p>
          </motion.div>
        </motion.div>
      </div>
